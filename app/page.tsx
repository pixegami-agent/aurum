  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav style={{ borderBottom: '1px solid #EBEBEB' }} className="fixed top-0 left-0 right-0 z-50 bg-white" >
        <div className="section-inner py-5 flex items-center justify-between">
      ...
      {/* HERO */}
      <section style={{ minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "center" }} className="section-inner pt-28 pb-20">
