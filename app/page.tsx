...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* HERO */}
      <section style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center' }} className="max-w-7xl mx-auto px-6 sm:px-10 md:px-16 pt-28 pb-20">
      ...
      <section id="contact" style={{ padding: '8rem 0', background: '#F5C518' }}>
        <div className="max-w-7xl mx-auto px-6 sm:px-10 md:px-16 text-center">
      ...
      <footer style={{ background: '#1A1A1A', padding: '3rem 0' }}>
        <div className="max-w-7xl mx-auto px-6 sm:px-10 md:px-16 flex flex-wrap items-center justify-between gap-4">
